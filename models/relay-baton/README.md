...
| | A（おねじ側） | B（めねじ側） | 組み立て後 |
|---|---|---|---|
| 造形サイズ | 38.5 × 38.5 × **153.1** mm | 38.5 × 38.5 × **153.1** mm | 全長280mm |
| 材料 | 20.2 cm³ / PLA約 25.0 g | 21.5 cm³ / PLA約 26.6 g | 約 **51.6 g** |
| フィラメント | 約8.4 m | 約8.9 m | 約17.3 m |

A・Bとも153.1mmで、A1 miniの180mmに27mmの余裕。ねじ込むと26.2mmが重なって
**全長ちょうど280mm**になります。重さ約52gなので、
...
筒の壁を三角形の枠に抜いた版。造形サイズは同じ153.1mmで合計41.5g。
...
| 継手の肉厚 | 溝の底でも1.6mm |
| 合わせたとき | 26.2mmが重なって**全長280mm**ちょうど |

山の斜面は軸に対して40°なので、**立てて刷ればサポートなしでそのまま出ます**。
オスの先端と根元は山を消してあるので、ねじ始めが引っかかりません。

オス側の段差は3mmのテーパです（垂直な段にすると細い側が空中に浮いて刷れません）。
メス側の入口には**同じ傾きの面取り**をつけてあり、テーパ同士が突きあたって0.84mm沈んで
止まります。この沈みこみを見こんで筒の長さを決めてあるので、合わせるとちょうど280mmです。
継ぎ目には幅・深さとも0.8mmの浅い溝が残ります（合わせ目の目印になります）。
